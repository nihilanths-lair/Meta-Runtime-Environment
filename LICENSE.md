...
* **Исходный код платформы:** Исходный код всей мета-платформы, включая инструментарий компиляции (`conv`) и среду исполнения виртуальной машины, является **проприетарным и закрытым**.
