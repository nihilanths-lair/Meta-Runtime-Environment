...
[MMICCE — Modifiable Modular Infrastructure for Compiler Construction and Execution / Модифицируемая модульная инфраструктура для создания и выполнения компиляторов]
