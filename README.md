...
^MMICCE — Modifiable Modular Infrastructure for Compiler Construction and Execution / Модифицируемая модульная инфраструктура для построения и выполнения компиляторов
